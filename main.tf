...
module "runners" {
  ...
  lambda_scale_up_memory_size      = var.runners_scale_up_Lambda_memory_size != null ? var.runners_scale_up_Lambda_memory_size : var.runners_scale_up_lambda_memory_size
