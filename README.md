...
| <a name="input_runner_credit_specification"></a> [runner\_credit\_specification](#input\_runner\_credit\_specification) | Credit specification for runners. Only applicable for T instance types. | `string` | `null` | no |
