...
locals {
  ...
  runner_metadata_tags_arn     = "${local.ssm_parameter_arn_prefix}/${trim(var.storage_provider.aws.ssm.paths.root, "/")}/${trim(var.storage_provider.aws.ssm.paths.config, "/")}/*.tags"
