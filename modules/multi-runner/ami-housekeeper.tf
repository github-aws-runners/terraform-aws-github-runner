...
module "ami_housekeeper" {
  count  = try(local.translated_experimental.compute_provider.ec2.ami.housekeeper.enabled, false) ? 1 : 0
  ...
  lambda_zip               = local.translated_experimental.compute_provider.ec2.ami.housekeeper.artifact.zip
  lambda_s3_bucket         = local.translated_experimental.compute_provider.ec2.ami.housekeeper.artifact.s3 == null ? null : local.translated_experimental.lambda.artifact.s3.bucket
  lambda_s3_key            = try(local.translated_experimental.compute_provider.ec2.ami.housekeeper.artifact.s3.key, null)
  lambda_s3_object_version = try(local.translated_experimental.compute_provider.ec2.ami.housekeeper.artifact.s3.object_version, null)
  ...
  lambda_memory_size        = local.translated_experimental.compute_provider.ec2.ami.housekeeper.lambda.memory_size
  lambda_timeout            = local.translated_experimental.compute_provider.ec2.ami.housekeeper.lambda.timeout
  ...
  cleanup_config             = local.translated_experimental.compute_provider.ec2.ami.housekeeper.cleanup_config
  lambda_schedule_expression = local.translated_experimental.compute_provider.ec2.ami.housekeeper.schedule.expression
}
