module "runners" {
  ...
  lambda_event_source_mapping_batch_size                         = each.value.orchestration.webhook.queue.event_source_mapping.batch_size
  lambda_event_source_mapping_maximum_batching_window_in_seconds = each.value.orchestration.webhook.queue.event_source_mapping.maximum_batching_window_in_seconds
  ...
  pool_lambda_timeout                        = each.value.orchestration.webhook.lambda.pool.lambda.timeout
  pool_lambda_memory_size                    = each.value.orchestration.webhook.lambda.pool.lambda.memory_size
  ...
  pool_lambda_reserved_concurrent_executions = each.value.orchestration.webhook.lambda.pool.lambda.reserved_concurrent_executions
