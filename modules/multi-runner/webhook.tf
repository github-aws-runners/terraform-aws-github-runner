...
module "webhook" {
  ...
  lambda_s3_bucket                              = local.translated_experimental.orchestration_provider.webhook.lambda.webhook.artifact.s3 == null ? null : local.translated_experimental.lambda.artifact.s3.bucket
  webhook_lambda_s3_key                         = try(local.translated_experimental.orchestration_provider.webhook.lambda.webhook.artifact.s3.key, null)
  webhook_lambda_s3_object_version              = try(local.translated_experimental.orchestration_provider.webhook.lambda.webhook.artifact.s3.object_version, null)
  webhook_lambda_apigateway_access_log_settings = local.translated_experimental.orchestration_provider.webhook.lambda.webhook.api_gateway_access_log_settings
  ...
  lambda_zip                                    = local.translated_experimental.orchestration_provider.webhook.lambda.webhook.artifact.zip
  lambda_timeout                                = local.translated_experimental.orchestration_provider.webhook.lambda.webhook.timeout
  lambda_memory_size                            = local.translated_experimental.orchestration_provider.webhook.lambda.webhook.memory_size
  lambda_tags                                   = merge(local.translated_experimental.lambda.tags, local.translated_experimental.orchestration_provider.webhook.lambda.webhook.tags)
  ...
  repository_white_list     = local.translated_experimental.orchestration_provider.webhook.github.repository_white_list
  queue_selection_strategy  = local.translated_experimental.orchestration_provider.webhook.queue_selection_strategy
