module "instance_termination_watcher" {
  ...
  count  = try(local.translated_experimental.compute_provider.ec2.instance_termination_watcher.enabled, false) ? 1 : 0
  ...
  config = {
    ...
    s3_bucket                    = local.translated_experimental.compute_provider.ec2.instance_termination_watcher.artifact.s3 == null ? null : local.translated_experimental.lambda.artifact.s3.bucket
    ...
    features                     = local.translated_experimental.compute_provider.ec2.instance_termination_watcher.features
    memory_size                  = local.translated_experimental.compute_provider.ec2.instance_termination_watcher.lambda.memory_size
    timeout                      = local.translated_experimental.compute_provider.ec2.instance_termination_watcher.lambda.timeout
    zip                          = local.translated_experimental.compute_provider.ec2.instance_termination_watcher.artifact.zip
    s3_key                       = try(local.translated_experimental.compute_provider.ec2.instance_termination_watcher.artifact.s3.key, null)
    s3_object_version            = try(local.translated_experimental.compute_provider.ec2.instance_termination_watcher.artifact.s3.object_version, null)
    enable_runner_deregistration = local.translated_experimental.compute_provider.ec2.instance_termination_watcher.enable_runner_deregistration
