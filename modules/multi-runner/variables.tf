  ...
  description = <<EOT
    multi_runner_config = {
      ...
      matcherConfig: {
        ...
        priority: "If set it defines the priority of the matcher, the matcher with the lowest priority will be evaluated first. Matchers with an exact or bidirectional label match are always evaluated ahead of the rest, regardless of priority. Default is 999."
