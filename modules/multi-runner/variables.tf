  ...
  description = <<EOT
    multi_runner_config = {
      ...
      matcherConfig: {
        ...
        priority: "If set it defines the priority of the matcher, the matcher with the lowest priority will be evaluated first. Default is 1000, allowed values 0-1000."
      }
