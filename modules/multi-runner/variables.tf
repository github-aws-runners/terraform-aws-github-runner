  ...
  description = <<EOT
    multi_runner_config = {
      runner_config: {
        ...
        enable_jit_config "Enable just-in-time (JIT) instance configuration for the runner instances. By default the feature is enabled for ephemeral runners, set this variable to overwrite the default behavior."
