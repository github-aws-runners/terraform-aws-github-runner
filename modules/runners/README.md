...
| <a name="input_ec2_custom_allowed_tags"></a> [ec2\_custom\_allowed\_tags](#input\_ec2\_custom\_allowed\_tags) | Allows the EC2 instance to create tags listed here. | `list(string)` | `[]` | no |
