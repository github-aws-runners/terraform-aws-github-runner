...
| <a name="output_role_runner"></a> [role\_runner](#output\_role\_runner) | Export explicit attributes, not the whole resource, to avoid deprecated-source warnings (#5159). |
