...
| <a name="input_userdata_get_runner_metadata"></a> [userdata\_get\_runner\_metadata](#input\_userdata\_get\_runner\_metadata) | User-data script snippet to get metadata and SSM configuration| `string` | `""` | no |
