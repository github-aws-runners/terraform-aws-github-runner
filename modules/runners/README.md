...
| <a name="input_userdata_enabled"></a> [userdata\_enabled](#input\_userdata\_enabled) | Should the userdata script be enabled for the runner. Set this to false if you are using your own prebuilt AMI | `bool` | `true` | no |
