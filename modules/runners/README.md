...
| <a name="output_warm_pool_dynamodb_table"></a> [warm\_pool\_dynamodb\_table](#output\_warm\_pool\_dynamodb\_table) | The DynamoDB table used for warm pool state tracking. Null when warm pool is disabled. |
<!-- END_TF_DOCS -->
