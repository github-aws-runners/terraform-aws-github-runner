...
| <a name="input_metrics_config"></a> [metrics\_config](#input\_metrics\_config) | Configuraiton to enable metrics creation by the lambdas. | <pre>object({<br>    enable    = optional(bool, false)<br>    namespace = optional(string, null)<br>  })</pre> | `{}` | no |
