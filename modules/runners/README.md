...
| <a name="input_ec2_custom_allowed_tags_creation"></a> [ec2\_custom\_allowed\_tags\_creation](#input\_ec2\_custom\_allowed\_tags\_creation) | Allows the EC2 instance to create tags listed here. | `list(string)` | `[]` | no |
