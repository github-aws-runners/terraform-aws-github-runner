...
| [aws_iam_policy_document.ssm_job_retry](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
...
| <a name="input_storage_provider"></a> [storage\_provider](#input\_storage\_provider) | Resolved storage-provider configuration and capability used by the job-retry Lambda. | <pre>object({<br/>    aws = object({<br/>      ssm = optional(object({<br/>        kms_key_id = optional(string, null)<br/>      }), null)<br/>    })<br/>  })</pre> | n/a | yes |
