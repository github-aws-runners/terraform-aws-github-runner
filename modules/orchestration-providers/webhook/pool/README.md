...
| [aws_iam_policy_document.ssm_pool_common](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
...
| <a name="input_storage_provider"></a> [storage\_provider](#input\_storage\_provider) | Resolved storage-provider configuration and capability used by the pool Lambda. | <pre>object({<br/>    aws = object({<br/>      ssm = optional(object({<br/>        token_path           = string<br/>        token_path_arn       = string<br/>        config_path          = string<br/>        config_path_arn      = string<br/>        kms_key_id           = optional(string, null)<br/>        parameter_store_tags = string<br/>      }), null)<br/>    })<br/>  })</pre> | n/a | yes |
