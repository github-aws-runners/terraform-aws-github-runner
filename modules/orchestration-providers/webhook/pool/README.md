...
| <a name="input_storage_provider"></a> [storage\_provider](#input\_storage\_provider) | Resolved storage-provider configuration and capability used by the pool Lambda. | <pre>object({<br/>    aws = object({<br/>      ssm = object({<br/>        token_path           = string<br/>        token_path_arn       = string<br/>        config_path          = string<br/>        config_path_arn      = string<br/>        kms_key_id           = optional(string, null)<br/>        parameter_store_tags = string<br/><br/>        parameter_store_max_concurrent_invocations = optional(number, 1)<br/>        parameter_store_max_writes_per_second      = optional(number, 40)<br/>      })<br/>    })<br/>    environment_variables = optional(map(string), {})<br/>    iam_policy_json       = optional(string, null)<br/>  })</pre> | n/a | yes |
