...
| <a name="input_storage_provider"></a> [storage\_provider](#input\_storage\_provider) | Storage-provider configuration used by the webhook resources. | <pre>object({<br/>    aws = object({<br/>      ssm = object({<br/>        kms_key_id = optional(string, null)<br/>        paths = object({<br/>          root    = string<br/>          webhook = string<br/>        })<br/>      })<br/>    })<br/>  })</pre> | n/a | yes |
