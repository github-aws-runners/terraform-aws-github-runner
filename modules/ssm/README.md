...
| [terraform_data.github_app_validation](https://registry.terraform.io/providers/hashicorp/terraform/latest/docs/resources/data) | resource |
...
| <a name="input_runner_registration_level"></a> [runner\_registration\_level](#input\_runner\_registration\_level) | The level at which runners are registered: "repo", "org", or "enterprise". When "enterprise", the GitHub App id/key are not required (a PAT is used instead). | `string` | `null` | no |
