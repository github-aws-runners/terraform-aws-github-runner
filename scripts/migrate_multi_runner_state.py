...
MIGRATION_MAPPINGS = (
    ...
    ('module.runners.aws_lambda_function.ssm_housekeeper', 'module.runner_configs.module.runner_config_housekeeper[0].aws_lambda_function.housekeeper'),
    ('module.runners.aws_cloudwatch_log_group.ssm_housekeeper', 'module.runner_configs.module.runner_config_housekeeper[0].aws_cloudwatch_log_group.housekeeper'),
    ('module.runners.aws_cloudwatch_event_rule.ssm_housekeeper', 'module.runner_configs.module.runner_config_housekeeper[0].aws_cloudwatch_event_rule.housekeeper'),
    ('module.runners.aws_cloudwatch_event_target.ssm_housekeeper', 'module.runner_configs.module.runner_config_housekeeper[0].aws_cloudwatch_event_target.housekeeper'),
    ('module.runners.aws_lambda_permission.ssm_housekeeper', 'module.runner_configs.module.runner_config_housekeeper[0].aws_lambda_permission.housekeeper'),
    ('module.runners.aws_iam_role.ssm_housekeeper', 'module.runner_configs.module.runner_config_housekeeper[0].aws_iam_role.housekeeper'),
    ('module.runners.aws_iam_role_policy.ssm_housekeeper', 'module.runner_configs.module.runner_config_housekeeper[0].aws_iam_role_policy.housekeeper'),
    ('module.runners.aws_iam_role_policy.ssm_housekeeper_logging', 'module.runner_configs.module.runner_config_housekeeper[0].aws_iam_role_policy.housekeeper_logging'),
    ('module.runners.aws_iam_role_policy_attachment.ssm_housekeeper_vpc_execution_role', 'module.runner_configs.module.runner_config_housekeeper[0].aws_iam_role_policy_attachment.housekeeper_vpc_execution_role'),
    ('module.runners.aws_iam_role_policy.ssm_housekeeper_xray', 'module.runner_configs.module.runner_config_housekeeper[0].aws_iam_role_policy.housekeeper_xray'),
)
